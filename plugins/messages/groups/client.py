...
group_filter = filters.ChatType.PRIVATE & ~filters.User(ADMIN_CHAT_ID)
...
def setup(bot: TelegramBot):
    ...
    call_plugins("Get user's comands", 'plugins.messages.users_handlers', 'get_handler_info', process_get_handler_info)
